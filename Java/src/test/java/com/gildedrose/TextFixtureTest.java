...
public class TextFixtureTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Files.write(Paths.get("Java/src/test/resources/gold.txt"), builder.toString().getBytes());
    }
